...
project = 'GFF-toolbox'
copyright = '2021, Felipe Almeida. GFF-toolbox: A toolbox of commands that tries to facilitate the work with GFF annotation files'
...
html_theme_options = {
    ...
    # repo info
    "repo_url": "https://github.com/fmalmeida/gff-toolbox",
    "repo_name": "gff-toolbox",
    "repo_type": "github",
